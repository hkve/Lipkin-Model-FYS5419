...
\noindent The results of using VQE on the simple 2x2 Hamiltonian is presented in \cref{fig:toy_1}. It is the lower section of \cref{fig:res:changing_character} extracted for comparison with VQE. It correctly predicts the ground state energy for this simple Hamiltonian, verifying the precision of the method for basic usage. This is an essential step in developing the system for more complex Hamiltonians and systems, which follows.
