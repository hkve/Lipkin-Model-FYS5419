...
Lastly we lift the $W=0$ restriction for four particles and consider the ground state energy as a function of both $V/\epsilon$ and $W/\epsilon$. In \cref{fig:res:lipkin_N4_vw_grid} we see the relative error from the diagonalization results. Additionally, we benchmark this against the HF and RPA solutions shown in \cref{fig:res:lipkin_N4_vw_grid_HF} and \cref{fig:res:lipkin_N4_vw_grid_RPA} respectively. 
% \begin{figure}[H]
%     \centering
